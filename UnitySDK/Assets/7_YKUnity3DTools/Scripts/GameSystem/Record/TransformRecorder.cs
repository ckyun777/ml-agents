...
public class TransformRecorder : MonoBehaviour {
	...
	public bool m_RecordTime = false;
	...
	void Start()
	{
		...
		m_RecordTransform.startTime = System.DateTime.Now.ToLongDateString() +System.DateTime.Now.ToString("yyMMddhhmmss.fff");
		Debug.Log(m_RecordTransform.startTime);

		if(m_SaveFileName == "")
		{
			m_SaveFileName = name + "_" + System.DateTime.Now.ToString("yyMMddhhmmss") + ".txt";
		}
		else
		{
			m_SaveFileName += "_" + System.DateTime.Now.ToString("yyMMddhhmmss") + ".txt";
		}
	...
	public IEnumerator Record()
	{
		...
		while(m_Record)
		{
			...
			if(m_RecordTime)
			{
				m_RecordTransform.m_TimeList.Add(System.DateTime.Now);
			}
	...
	{
		m_RecordTransform.endTime = System.DateTime.Now.ToLongDateString() + System.DateTime.Now.ToString("yyMMddhhmmss.fff");
